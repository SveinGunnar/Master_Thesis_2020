...
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 9 7 16
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 8 8 16
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 7 9 16
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 6 10 16
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 5 11 16
#numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 4 12 16
numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 3 13 16
numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 2 14 16
numactl --physcpubind=0-15 --membind=0 ./Page_rank.out DRAM_only/neighbours_8_16M.txt 1 15 16
