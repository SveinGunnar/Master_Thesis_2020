...
echo 1
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 24 15 1 $k >> $file_name
echo 2
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 48 14 2 $k >> $file_name
echo 3
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 73 13 3 $k >> $file_name
echo 4
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 98 12 4 $k >> $file_name
echo 5
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 123 11 5 $k >> $file_name
echo 6
numactl --physcpubind=0-15 ./LargeArrayTest.out $m $n 148 10 6 $k >> $file_name
