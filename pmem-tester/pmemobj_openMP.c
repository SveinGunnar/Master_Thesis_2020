...
#define DRAM_THREADS 2
#define NVM_THREADS 2
...
int main(int argc, char *argv[])
{
	...
	double **drm_read_array = (double**)malloc(DRAM_THREADS*sizeof(double*));
	double **drm_write_array = (double**)malloc(DRAM_THREADS*sizeof(double*));

	for(i=0;i<DRAM_THREADS;i++){
		drm_read_array[i] = (double*)malloc(ARRAY_LENGTH*sizeof(double));
		drm_write_array[i] = (double*)malloc(ARRAY_LENGTH*sizeof(double));
	}
